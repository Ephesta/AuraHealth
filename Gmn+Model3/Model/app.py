...
YOUR_GEMINI_API_KEY = 'YOUR_GEMINI_API_KEY' #YOUR_GEMINI_API_KEY/SENİN GEMİNİ ANAHTARIN
OPENWEATHER_API_KEY = 'YOUR_OPENWEATHER_API_KEY' #YOUR_OPENWEATHER_API_KEY/SENİN OPENWEATHER API ANAHTARIN
...
def get_air_pollution():
    ...
    try:
        api_key = "YOUR_OPENWEATHERMAP_API_KEY" #YOUR_OPENWEATHERMAP_API_KEY/ SENİN_OPENWEATHERMAP_API_KEYİN
